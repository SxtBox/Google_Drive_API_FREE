...
namespace Google_Drive\StreamingLinkGenerator;
...
use Google_Drive\StreamingLinkGenerator\CookieLoader\CookieLoaderInterface;
...
class Generator
{
    ...
    public function generate(string $googleDriveFileId): StreamingLink
    {
        ...
        if ($response->getStatusCode() !== 200) {
            ...
            'Incorrect HTTP Response ('. $response->getStatusCode(). ' code) from Google for Generate Link'
            );
        }
